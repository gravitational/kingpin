...
// UsageRenderer (no text/template) do not link in reflect.MethodByName,
// which is the key indicator that dead code elimination is working.
//
// Inspired by https://github.com/spf13/cobra/pull/1956.
